...
- **[review](./skills/engineering/review/SKILL.md)** — Two-axis diff review (Standards + Spec) since a fixed point (commit/branch/tag/merge-base). Runs both axes as parallel sub-agents and reports them side by side.
